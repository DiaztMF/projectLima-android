...
Native Android educational project demonstrating Fragments, ViewPager, and TabLayout interactions, developed as part of the Mobile App Development curriculum.
...
``bash
git clone https://github.com/DiaztMF/projectLima-android.git
cd projectLima-android
``
...
$rName is a focused Android development assignment created to master foundational mobile engineering patterns. It explores Fragments, ViewPager, and TabLayout interactions through clean Android architecture guidelines.

## Why 

Mastering native Android development requires solid understanding of core framework components, UI lifecycles, and threading boundaries. This project provides hands-on practical implementation of Fragments, ViewPager, and TabLayout interactions without third-party abstraction overhead.
...
protected void onCreate(Bundle savedInstanceState) {
    ...
    Log.d("projectLima-android", "Activity initialized successfully");
}
``
